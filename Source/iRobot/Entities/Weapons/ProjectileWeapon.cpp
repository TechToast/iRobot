...
bool AProjectileWeapon::SERVER_FireProjectile_Validate(FVector Origin, FVector_NetQuantizeNormal ShootDir)
{
	return true;
}


void AProjectileWeapon::SERVER_FireProjectile_Implementation(FVector Origin, FVector_NetQuantizeNormal ShootDir)
{
...
/*void AProjectileWeapon::ApplyWeaponData(FProjectileWeaponData& Data)
{
	Data = ProjectileWeaponData;
}*/
